...
if not GEMINI_AVAILABLE:
    print("[STARTUP] ERROR: google.generativeai failed to import. Check package installation.")
...
def cmd_aicheck(message):
    ...
    status = (
        f"🔍 AI Diagnostic\n"
        f"━━━━━━━━━━━━━━━━━\n"
        f"📦 Package loaded: {'✅ Yes' if GEMINI_AVAILABLE else '❌ No (import failed)'}\n"
...
def run_bot():
    ...
    while True:
        ...
        try:
            ...
            logger.error("Polling stopped: %s — restarting in 15s", e)
            time.sleep(15)
